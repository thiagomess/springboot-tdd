...
public class WalletItemControllerTest {
	...
	@Test
	@WithMockUser // mocka o usuario autenticado 
	public void testFindBetweemDates() throws Exception {
		...
		BDDMockito.given(service.findBetweenDates(Mockito.anyLong(), Mockito.any(Date.class), Mockito.any(Date.class), Mockito.any(PageRequest.class))).willReturn(page);
		
		//Linhas para mockar que o id do Wallet pesquisado, seja o mesmo do usuario autenticado na aplicação
		//mockando a linha 71 do controller
	...
	public void testFindByType() throws Exception {
		...
		//Linhas para mockar que o id do Wallet pesquisado, seja o mesmo do usuario autenticado na aplicação
		//mockando a linha 90 do controller
		BDDMockito.given(userService.findByEmail(Mockito.anyString())).willReturn(Optional.of(user));
		BDDMockito.given(userWalletService.findByUsersIdAndWalletId(Mockito.anyLong(), Mockito.anyLong())).willReturn(Optional.of(new UserWallet()));
		//
	...
	public void testUpdate() throws Exception {
		...
		BDDMockito.given(service.update(Mockito.any(WalletItem.class))).willReturn(new WalletItem(1L, w, DATE, TypeEnum.SD, description, VALUE));
	...
	// Monta o payload da requisicao JSON
